          ...
          <div className="relative z-10 flex flex-col h-full p-16">
            <div className="flex items-center justify-between mb-10">
              <div className="flex items-center space-x-6">
                ...
                <div>
                  <h2 className="text-5xl font-black tracking-tighter leading-none text-slate-900">JEE STUDY HUB</h2>
            ...
            <div className="pt-6 mt-auto border-t border-slate-200 flex flex-col items-center">
              <div className="flex items-center space-x-3 mb-2">
                ...
                <p className="text-2xl font-black text-slate-900 tracking-[0.4em] leading-none uppercase w-full">POWERED BY JEE STUDY HUB</p>
              </div>
